      ...
      <Page size="A4" style={styles.page}>
        <View style={styles.outerBorder}>
          ...
          {<View style={{ flexDirection: 'column', textAlign: 'left', fontSize: 15, marginTop: 20 }}>
              ...
              {data?.driverPhotosUpload?.length > 0 && data.withdrawOfClaim === "no" && (
                <>
              ...
              {data?.spotPhotosUpload?.length > 0 && data.withdrawOfClaim === "no" && (
                <>
              ...
              {data?.garagePhotosUpload?.length > 0 && data.withdrawOfClaim === "no" && (
                <>
